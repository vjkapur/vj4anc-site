...
last_modified_at: 2022-09-30T17:36:56
---
## tl;dr
...
- **Council email addresses** are moving from `dccouncil.us` to `dccouncil.gov`; emails should forward but it's **best to update now**.
...
- **BZA Case [20779](https://app.dcoz.dc.gov/CaseReport/CaseReportPage.aspx?case_id=20779) to create a four-unit residential building** in Brentwood remains in limbo because it has **not been given an opportunity to present to an SMD meeting yet**
